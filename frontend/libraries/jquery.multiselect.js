...
(function ($) {
    ...
    MultiSelect.prototype = {
        ...
        load: function () {
            ...
            $(instance.element).after('<div id="ms-list-' + instance.listNumber + '" class="ms-options-wrap bg-input-user"><button type="button"><span>None Selected</span></button><div class="ms-options shadow-sm rounded p-2"><ul></ul></div></div>');
            ...
            if (instance.options.search) {
                optionsList.before('<div class="ms-search form-group m-0"><input class=" form-control bg-input-user text-dark mb-0" type="text" value="" placeholder="' + instance.options.texts.search + '" /></div>');
