...
(function ($) {
    var defaults = {
        ...
        searchOptions: {
            delay: 50,                  // time (in ms) between keystrokes until search happens
    ...
    MultiSelect.prototype = {
        ...
        load: function () {
            ...
            $(instance.element).after('<div id="ms-list-' + instance.listNumber + '" class="ms-options-wrap bg-input-user"><button type="button" class="px-2"><span>None Selected</span></button><div class="ms-options shadow-sm rounded p-2"><ul></ul></div></div>');
            ...
            optionsWrap.css({
                ...
                width: instance.options.maxWidth,
            ...
            if (instance.options.search) {
                optionsList.before('<div class="ms-search form-group m-0"><input class="form-control form-control-sm  bg-input-user text-dark mb-0"  type="text" value="" placeholder="' + instance.options.texts.search + '" /></div>');
            ...
            if (instance.options.selectAll) {
                optionsList.before('<button style="text-decoration: none"  class="ms-selectall w-100 global btn btn-sm btn-block btn-light-primary mx-0 my-2">' + instance.options.texts.selectAll + '</button>');
            }
        ...
        _addOption: function (container, option) {
            ...
            var thisCheckbox = $('<input>', {
                ...
                value: option.value,
                class: "form-check-input input-success me-2"
            });
