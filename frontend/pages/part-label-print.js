...
import { smallLabelv2 } from '../firebase/printerlabelConstant'
...
const ScanningAndPrinting = () => {
    ...
    function writeToSelectedPrinter(data) {
        let dataToWrite = smallLabelv2(data)
    ...
    function validateData() {
        ...
        qrstring += (materialcode + stringseprator)
        ...
        console.log(customerbarcodetemplate.split("#"), qrstring, model, customer);
    ...
    return (
        ...
        < main className='d-flex flex-column min-vh-100' >
            <Head title={"Part Label"} />

            <div id="main" className="layout-navbar">
                <header>
                    <Navbar pagename={"Part Label"} />
                </header>
                <div id="main-content">
                                            ...
                                            <div className="card h-100 border p-1 mb-0">
                                                <div className="card-header py-3 px-2">
                                                    ...
                                                    <div className="d-flex flex-row justify-content-between align-center">
                                                        <h5 className="my-auto fs-6 text-dark">Part Label</h5>
...
export async function getStaticProps() {
    return {
        props: { module: "PARTLABELPRINT", onlyAdminAccess: false }
    };
}