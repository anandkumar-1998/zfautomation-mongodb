                    ...
                    <div className="row align-items-center text-center">
                        <div className="col-md-12 px-1">
                            ...
                            <div className="card-body py-3">
                                <h3 className="mt-2 mb-3 text-center w-100 f-w-400 fw-bold fs-3">Access Forbidden</h3>
                                <h6 className="text-start text-center w-100 f-w-400 text-capitalize">{message}</h6>
                                <br />
