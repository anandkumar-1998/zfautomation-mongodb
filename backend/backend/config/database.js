...
const connectDatabase = () => {
  var DBURL = `mongodb://${process.env.DB_IP}:${process.env.DB_PORT}/${process.env.DB_BASENAME}_${process.env.ENVTYPE}?directConnection=true&retryWrites=true&appName=app1`;
